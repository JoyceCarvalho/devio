$(function () {
    ...
    // ---------------------------------------------- //
    $('#open-pedido').click(function (e) {
        e.preventDefault();
        $('.pedido-overlay').fadeIn();
        $('body').css({'overflow': 'hidden'});

        setTimeout(function () {
            $('#pedido-modal').addClass('is-visible');
        }, 100);
    });

    $('#close').click(function () {
        $('.pedido-overlay').fadeOut();
        setTimeout(function () {
            $('body').css('overflow', 'auto');
        }, 400);
        $('#pedido-modal').removeClass('is-visible');
    });
    // Segundo modal
    $('#open-admin').click(function (e) {
        e.preventDefault();
        $('.admin-overlay').fadeIn();
        $('body').css({'overflow': 'hidden'});

        setTimeout(function () {
            $('#admin-modal').addClass('is-visible');
        }, 100);
    });
    ...
    $('#close2').click(function () {
        ...
        $('#admin-modal').removeClass('is-visible');
    });
